...
const Home = () => {
    ...
    return (
        <div className="" style={{ backgroundImage: "url('/images/camo-back.jpg')", }}>
            ...
            <section className='nftreward text-white  ' id="Reward" style={{ background: '#072008', }}>
                <div className=''>
                    <div className=' row m-0 justify-content-end'>
                        ...
                        <div className=' d-flex flex-row col-md-12 my-4 cards'>
                            <NftCard imgsrc='/images/metatrader-monkey.jpeg' heading='Meta Trader' btntext={'Mint'} linkdata="https://metatraderarmy.netlify.app/mint/?nft=1" />
                            <NftCard imgsrc='/images/1.jpeg' heading='Meta Trader' btntext={'Mint'} linkdata="https://metatraderarmy.netlify.app/mint/?nft=2" />
                            <NftCard imgsrc='/images/2.jpeg' heading='Meta Trader' btntext={'Mint'} linkdata="https://metatraderarmy.netlify.app/mint/?nft=3" />
                            <NftCard imgsrc='/images/3.jpeg' heading='Meta Trader' btntext={'Mint'} linkdata="https://metatraderarmy.netlify.app/mint/?nft=4" />
